...
data class TileSpec(
    ...
    companion object {
        ...
        /**
         * 创建宽矩形瓷砖规格 (2×4) - 用于预设，自动获得动画
         * 默认使用 SLIDE 滑动动画，适合列表和滚动内容
         */
        fun wideMedium(color: Color) = TileSpec(2, 4, color, AnimationType.SLIDE)

        /**
         * 创建高矩形瓷砖规格 (4×2) - 用于预设，自动获得动画
         * 默认使用 FLIP 翻转动画，适合详细信息展示
         */
        fun tall(color: Color) = TileSpec(4, 2, color, AnimationType.FLIP)
        ...
        /**
         * 创建带动画的宽矩形瓷砖规格 (2×4) - 用于自定义内容
         */
        fun wideMedium(color: Color, animation: AnimationType) = TileSpec(2, 4, color, animation)

        /**
         * 创建带动画的高矩形瓷砖规格 (4×2) - 用于自定义内容
         */
        fun tall(color: Color, animation: AnimationType) = TileSpec(4, 2, color, animation)
